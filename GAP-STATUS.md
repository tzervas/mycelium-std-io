# Gap status — `mycelium-std-io`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-std-io` |
| **Role** | std.io + serialize |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-std-io-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | docs/GAP-socket-substrate-and-json.md |
| **Related issues** | https://github.com/tzervas/mycelium-std-io/issues/6 |
